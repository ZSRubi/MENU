...
=======
        jComboBoxComidas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Seleccionar-", "Lumes", "Arroz De Mariscos", "Filete Playero", "Pulpo con Camarón en Salsa verde", "Camarones al Coco", "Pizza al horno Camarón", "Pizza al horno Marinera", "Almeja Chocolata" }));
>>>>>>> Stashed changes
